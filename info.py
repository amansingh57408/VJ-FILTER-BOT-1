...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7877084451').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002280686471') # give your force subscribe channel id here else leave it blank
